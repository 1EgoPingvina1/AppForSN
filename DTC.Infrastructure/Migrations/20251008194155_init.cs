    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorGroupsMembers", x => new { x.Author_ID, x.AuthorGroup_ID });
                    table.ForeignKey(
                        name: "FK_AuthorGroupsMembers_AuthorGroups_AuthorGroup_ID",
                        column: x => x.AuthorGroup_ID,
                        principalTable: "AuthorGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorGroupsMembers_Authors_Author_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMainFile = table.Column<bool>(type: "boolean", nullable: false),
