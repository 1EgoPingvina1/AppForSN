...
namespace DTC.Infrastructure.Migrations
{
    ...
    [Migration("20250824162421_AddAuthorsHandling")]
    partial class AddAuthorsHandling
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DTC.Domain.Entities.Main.AuthorGroupMember", b =>
                {
                    ...
                    b.HasKey("Author_ID", "AuthorGroup_ID");
            ...
            modelBuilder.Entity("DTC.Domain.Entities.Main.AuthorGroupMember", b =>
                {
                    b.HasOne("DTC.Domain.Entities.Main.AuthorGroup", "AuthorGroup")
                        .WithMany("Members")
                        .HasForeignKey("AuthorGroup_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DTC.Domain.Entities.Main.Author", "Author")
